...
impl AIRequestUsageModel {
    ...
    fn has_usable_member_byo_inference_path<S: TeamScope + ?Sized>(
        ...
        // Local fork: a configured custom endpoint counts even without an API
        // key, since local inference servers commonly require none.
        let has_custom_endpoint = api_keys
            .keys()
            .custom_endpoints
            .iter()
